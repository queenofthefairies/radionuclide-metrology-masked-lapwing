...
regression_data_filename='Ho166m-LS2-win2_siobhan_AC_test_rt250dt50_RegData_doubles_WM_ACcorr_newunceqns.xlsx'
fits_filename="Ho166m-LS2-win2_siobhan_AC_test_rt250dt50_AllFits_doubles_OSD_WM_ACcorr_newunceqns.xlsx"
...
type_of_fit = 'linear' # 'linear' OR 'cubic'
type_of_reg = 'LS' # 'LS' OR 'ODR'
what_to_plot = 'BGC' # 'BGC' for BG/C vs G/C-1, OR 'B' for B vs 1-C/G 
